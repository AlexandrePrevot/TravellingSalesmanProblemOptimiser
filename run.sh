...
if [ $# -lt 2 ]; then
  ...
  echo "Usage: $0 <cppbuild> <pythonvenv>"
  exit 1
fi
...
python3 -m grpc_tools.protoc -I/messages/ --python_out=/frontend/generated/ --pyi_out=/frontend/generated/ --grpc_python_out=/frontend/generated/ ./messages/request.proto &&
cd $1 &&
...
./TravellingSalesmanProblemOptimiser && cd - &&
python3 frontend/tsp_optimize.py
